#region Header Info
//-----------------------------------------------------------------------
// <copyright file="BDFaultException.cs" company="Calendar.Framework">
...
namespace Calendar.Framework
{
    ...
    /// </summary>
    [Serializable]
    public class BDFaultException : System.Exception
    {
        #region Constants
        /// <summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the SarasFaultException class.
        /// </summary>
        public BDFaultException()
        {
        }
        ...
        public BDFaultException(string message, System.Exception ex) : base(message, ex)
        {
            if (ex != null)
            {
        ...
        /// </summary>
        /// <param name="message">Message text describing the exception.</param>
        public BDFaultException(string message) : base(message)
        {
        }

        /// <summary>
        /// Initializes a new instance of the SarasFaultException class. object for deserialization.
        /// </summary>
        /// <param name="info">Serialization info.</param>
        /// <param name="context">Serialiation context.</param>
        protected BDFaultException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base(info, context)
        {
